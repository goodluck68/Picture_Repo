...
def test_bgp_route_with_suppress(duthost, tbinfo, nbrhosts, ptfadapter, localhost, restore_bgp_suppress_fib,
    ...
    try:
        ...
        with allure.step("Validate traffic could not be forwarded to T0 VM"):
            ...
            validate_traffic(ptfadapter, traffic_data_ipv4_drop, router_mac, ptf_interfaces, recv_port)
            validate_traffic(ptfadapter, traffic_data_ipv6_drop, router_mac, ptf_interfaces, recv_port)
        ...
        with allure.step("Validate announced BGP ipv4 and ipv6 routes are not in {} state".format(QUEUED)):
            validate_route_states(duthost, ip_routes_ipv4, vrf_type, check_point=QUEUED, action=ACTION_NOT_IN)
            validate_route_states(duthost, ip_routes_ipv6, vrf_type, check_point=QUEUED, action=ACTION_NOT_IN)

        with allure.step("Validate announced BGP ipv4 and ipv6 routes are in {} state".format(OFFLOADED)):
            validate_route_states(duthost, ip_routes_ipv4, vrf_type, check_point=OFFLOADED)
            validate_route_states(duthost, ip_routes_ipv6, vrf_type, check_point=OFFLOADED)
        ...
        with allure.step("Validate BGP ipv4 and ipv6 routes are announced to T2 VM peer"):
            ...
            validate_route_propagate(duthost, tbinfo, vrf_type, ipv6_route_list=ip_routes_ipv6)

        with allure.step("Validate traffic would be forwarded to T0 VM"):
            validate_traffic(ptfadapter, traffic_data_ipv4_forward, router_mac, ptf_interfaces, recv_port)
            validate_traffic(ptfadapter, traffic_data_ipv6_forward, router_mac, ptf_interfaces, recv_port)
...
# @pytest.mark.parametrize("vrf_type", VRF_TYPES)
# def test_bgp_route_with_suppress_stress(duthost, tbinfo, nbrhosts, ptfadapter, localhost, restore_bgp_suppress_fib,
...
#         for _ in range(10):
#             with allure.step("Announce BGP ipv4 and ipv6 routes to DUT from T0 VM by ExaBGP"):
#                 install_route_from_exabgp(ANNOUNCE, ptf_ip, ip_routes_ipv4_stress, exabgp_port)
#                 install_route_from_exabgp(ANNOUNCE, ptf_ip, ip_routes_ipv6_stress, exabgp_port_v6)
#
#             with allure.step("Validate announced BGP ipv4 and ipv6 routes are in {} state".format(QUEUED)):
#                 validate_route_states(duthost, ip_routes_ipv4_stress, vrf_type)
#                 validate_route_states(duthost, ip_routes_ipv6_stress, vrf_type)
#
#             with allure.step("Validate BGP ipv4 and ipv6 routes are not announced to T2 VM peer"):
#                 validate_route_propagate(duthost, tbinfo, vrf_type, exist=False, ipv4_route_list=ip_routes_ipv4_stress)
#                 validate_route_propagate(duthost, tbinfo, vrf_type, exist=False, ipv6_route_list=ip_routes_ipv6_stress)
#
#             with allure.step("Withdraw BGP ipv4 and ipv6 routes to DUT from T0 VM by ExaBGP"):
#                 install_route_from_exabgp(WITHDRAW, ptf_ip, ip_routes_ipv4_stress, exabgp_port)
#                 install_route_from_exabgp(WITHDRAW, ptf_ip, ip_routes_ipv6_stress, exabgp_port_v6)
#
#         with allure.step("Announce BGP ipv4 and ipv6 routes to DUT from T0 VM by ExaBGP"):
#             install_route_from_exabgp(ANNOUNCE, ptf_ip, ip_routes_ipv4_stress, exabgp_port)
#             install_route_from_exabgp(ANNOUNCE, ptf_ip, ip_routes_ipv6_stress, exabgp_port_v6)
...
#         with allure.step("Validate traffic could not be forwarded to T0 VM"):
#             ptf_interfaces = get_t2_ptf_intfs(mg_facts)
#             validate_traffic(ptfadapter, traffic_data_ipv4_drop_stress, router_mac, ptf_interfaces, recv_port)
#             validate_traffic(ptfadapter, traffic_data_ipv6_drop_stress, router_mac, ptf_interfaces, recv_port)
#
#         with allure.step("Restore orchagent process"):
#             operate_orchagent(duthost, action=ACTION_CONTINUE)
#
#         with allure.step("Validate announced BGP ipv4 and ipv6 routes are not in {} state".format(QUEUED)):
#             validate_route_states(duthost, ip_routes_ipv4_stress, vrf_type, check_point=QUEUED, action=ACTION_NOT_IN)
#             validate_route_states(duthost, ip_routes_ipv6_stress, vrf_type, check_point=QUEUED, action=ACTION_NOT_IN)
#
#         with allure.step("Validate announced BGP ipv4 and ipv6 routes are in {} state".format(OFFLOADED)):
#             validate_route_states(duthost, ip_routes_ipv4_stress, vrf_type, check_point=OFFLOADED)
#             validate_route_states(duthost, ip_routes_ipv6_stress, vrf_type, check_point=OFFLOADED)
#
#         with allure.step("Validate BGP ipv4 and ipv6 routes are announced to T2 VM peer"):
#             validate_route_propagate(duthost, tbinfo, vrf_type, ipv4_route_list=ip_routes_ipv4_stress)
#             validate_route_propagate(duthost, tbinfo, vrf_type, ipv6_route_list=ip_routes_ipv6_stress)
#
#         with allure.step("Validate traffic would be forwarded to T0 VM"):
#             validate_traffic(ptfadapter, traffic_data_ipv4_forward_stress, router_mac, ptf_interfaces, recv_port)
#             validate_traffic(ptfadapter, traffic_data_ipv6_forward_stress, router_mac, ptf_interfaces, recv_port)
#
#     finally:
#         if vrf_type == USER_DEFINED_VRF:
#             with allure.step("Clean user defined vrf"):
